<x-admin-layout :breadcrumbs="[
    ...
    <div class="flex flex-col md:flex-row w-full gap-6 p-6 max-w-full mx-auto">
        ...
        <div
            ...
            <h2 class="text-lg font-semibold mb-5 text-gray-900 dark:text-white">Usuarios últimos 7 días</h2>
        ...
        <div
            ...
            <h2 class="text-lg font-semibold mb-3 text-gray-900 dark:text-white">Accesos de los últimos 6 meses</h2>
            ...
            <div class="flex justify-between mb-3">
                <div class="flex items-center">
                    <div class="flex justify-center items-center">
                        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">Total de
                            Registrados</h5>
                        <!-- Icono info -->
                        <svg data-popover-target="chart-info" data-popover-placement="bottom"
    ...
    @push('js')
        <script>
            ...
            // ------------------- Gráfico 2: Barras horizontales con datos reales -------------------
            // Extraemos los datos de accesos por mes para ingresos y egresos
            // Extraer datos
            ...
            // ------------------- Gráfico 3: Líneas -------------------
            const etiquetasLinea = @json($etiquetas); // ["07 Jul", "08 Jul", ...]
            const datosLinea = @json($datosLinea);
            console.log("Etiquetas:", etiquetasLinea);
            ...
            const optionsLine = {
                ...
                xaxis: {
                    categories: etiquetasLinea, // ["07 Jul", "08 Jul", ...]
                    labels: {
                        rotate: -45, // ← Inclina etiquetas para que no se encimen
                        style: {
                            fontSize: '12px',
                            fontFamily: 'Inter, sans-serif',
                            cssClass: 'text-xs font-normal fill-gray-500 dark:fill-gray-400'
                ...
                grid: {
                    padding: {
                        bottom: 20 // ← Espacio adicional para que no se corte
                    }
                },
                tooltip: {
                    shared: true,
            ...
            const etiquetas = tipos.map(t => t.charAt(0).toUpperCase() + t.slice(1));
            const colores = ["#FDBA8C", "#16BDCA", "#1C64F2"]; // naranja, verde, azul
