{{-- <x-reconigtion-layout>
    ...
    <div class="fixed inset-0 h-full w-full bg-gradient-to-br from-indigo-950 via-slate-900 to-purple-950 -z-10 overflow-hidden">
        ...
        <div class="absolute inset-0">
            ...
            <div class="absolute bottom-1/3 right-1/3 w-80 h-80 bg-violet-400/5 rounded-full blur-3xl animate-pulse" style="animation-delay: 1.5s;"></div>
            <div class="absolute top-1/2 left-1/2 w-64 h-64 bg-blue-400/5 rounded-full blur-3xl animate-pulse" style="animation-delay: 3s;"></div>
            <div class="absolute top-10 right-10 w-32 h-32 bg-emerald-400/5 rounded-full blur-2xl animate-pulse" style="animation-delay: 0.5s;"></div>
        </div>
        
        <!-- Patrón de puntos decorativo -->
        <div class="absolute inset-0 opacity-10">
            <div class="absolute top-20 left-20 w-2 h-2 bg-cyan-400 rounded-full animate-ping"></div>
            <div class="absolute top-40 right-32 w-1 h-1 bg-violet-400 rounded-full animate-ping" style="animation-delay: 2s;"></div>
            <div class="absolute bottom-32 left-40 w-1.5 h-1.5 bg-blue-400 rounded-full animate-ping" style="animation-delay: 4s;"></div>
        </div>
    </div>
    ...
    <div class="min-h-screen p-4 md:p-6 lg:p-8">
        <div class="max-w-7xl mx-auto">
            <div class="bg-slate-900/40 backdrop-blur-2xl border border-slate-700/30 rounded-3xl p-6 md:p-8 shadow-2xl shadow-black/50 hover:shadow-cyan-500/10 transition-all duration-700">
                
                <!-- Header mejorado -->
                <header class="flex flex-col lg:flex-row justify-between items-center border-b border-gradient-to-r from-transparent via-slate-600/30 to-transparent pb-8 mb-8">
                    <div class="flex items-center gap-6">
                        <!-- Logo con efectos -->
                        <div class="relative group">
                            <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-500 via-blue-600 to-violet-600 flex items-center justify-center font-black text-white shadow-2xl shadow-blue-500/30 group-hover:scale-105 transition-transform duration-300">
                                UA
                            </div>
                            <div class="absolute -inset-1 bg-gradient-to-br from-cyan-500 via-blue-600 to-violet-600 rounded-2xl blur-lg opacity-30 group-hover:opacity-50 transition-opacity duration-300"></div>
                        </div>
                        
                        <div class="text-left">
                            <h1 class="text-3xl md:text-4xl font-black bg-gradient-to-r from-cyan-400 via-blue-400 to-violet-400 bg-clip-text text-transparent drop-shadow-sm">
                                Control de Acceso
                            </h1>
                            <p class="text-slate-400 font-medium tracking-wide mt-1">Sistema Universitario Inteligente</p>
                        </div>
                    </div>
                    ...
                    <div class="text-right mt-6 lg:mt-0 bg-slate-800/50 p-4 rounded-2xl border border-slate-600/30">
                        <div id="live-time" class="text-2xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">Loading...</div>
                ...
                <div class="grid lg:grid-cols-[400px_1fr] gap-8">
                    ...
                    <section class="relative bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl border border-slate-600/30 rounded-3xl p-8 group hover:border-cyan-500/50 transition-all duration-500 shadow-xl">
                        <!-- Borde superior decorativo -->
                        <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-cyan-500 via-blue-500 to-violet-500 rounded-t-3xl"></div>
                        ...
                        <div class="w-40 h-40 mx-auto mb-8 relative group">
                            ...
                            <div class="absolute -inset-2 bg-gradient-to-r from-cyan-500 via-blue-500 to-violet-500 rounded-full blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-300"></div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="group/item bg-gradient-to-r from-slate-700/30 to-slate-800/30 p-5 rounded-2xl border border-slate-600/30 hover:border-cyan-400/50 hover:from-slate-700/50 hover:to-slate-800/50 transition-all duration-300 cursor-pointer">
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center text-white text-xl shadow-lg">
                                        🏢
                                    </div>
                                    <div class="flex-1">
                                        <p class="text-xs text-slate-400 uppercase font-bold tracking-widest">Edificio</p>
                                        <p class="text-lg font-semibold text-white group-hover/item:text-cyan-400 transition-colors">Torre A</p>
                                    </div>
                                </div>
                            </div>

                            <div class="group/item bg-gradient-to-r from-slate-700/30 to-slate-800/30 p-5 rounded-2xl border border-slate-600/30 hover:border-violet-400/50 hover:from-slate-700/50 hover:to-slate-800/50 transition-all duration-300 cursor-pointer">
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 bg-gradient-to-br from-violet-500 to-purple-500 rounded-xl flex items-center justify-center text-white text-xl shadow-lg">
                                        🎓
                                    </div>
                                    <div class="flex-1">
                                        <p class="text-xs text-slate-400 uppercase font-bold tracking-widest">Carrera</p>
                                        <p class="text-lg font-semibold text-white group-hover/item:text-violet-400 transition-colors">Ingeniería de Sistemas</p>
                                    </div>
                                </div>
                            </div>

                            <div class="group/item bg-gradient-to-r from-slate-700/30 to-slate-800/30 p-5 rounded-2xl border border-slate-600/30 hover:border-emerald-400/50 hover:from-slate-700/50 hover:to-slate-800/50 transition-all duration-300 cursor-pointer">
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center text-white text-xl shadow-lg">
                                        📧
                                    </div>
                                    <div class="flex-1">
                                        <p class="text-xs text-slate-400 uppercase font-bold tracking-widest">Email</p>
                                        <p id="email" class="text-sm font-medium text-white group-hover/item:text-emerald-400 transition-colors break-all">brayan.sonco@universidad.edu</p>
                                    </div>
                                </div>
                            </div>

                            <div class="group/item bg-gradient-to-r from-slate-700/30 to-slate-800/30 p-5 rounded-2xl border border-slate-600/30 hover:border-yellow-400/50 hover:from-slate-700/50 hover:to-slate-800/50 transition-all duration-300 cursor-pointer">
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-xl flex items-center justify-center text-white text-xl shadow-lg">
                                        📱
                                    </div>
                                    <div class="flex-1">
                                        <p class="text-xs text-slate-400 uppercase font-bold tracking-widest">Teléfono</p>
                                        <p id="telefono" class="text-lg font-semibold text-white group-hover/item:text-yellow-400 transition-colors">+591 123 456 789</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="space-y-8">
                        ...
                        <div id="statusCard" class="relative text-center p-10 rounded-3xl border border-emerald-500/40 bg-gradient-to-br from-emerald-900/20 to-green-900/20 backdrop-blur-xl shadow-2xl group hover:scale-[1.02] transition-all duration-500">
                            <div class="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-emerald-400 via-green-400 to-emerald-500 rounded-t-3xl"></div>
                            <div class="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-green-500/5 rounded-3xl"></div>
                            
                            <div class="relative z-10">
                                <div class="text-8xl mb-6 status-icon animate-pulse group-hover:scale-110 transition-transform duration-300">🔓</div>
                                <h3 id="statusText" class="text-4xl font-black text-emerald-400 uppercase tracking-widest drop-shadow-lg mb-3">
                                    Acceso Autorizado
                                </h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="group text-center p-8 rounded-3xl border border-slate-600/30 bg-gradient-to-br from-blue-900/20 to-cyan-900/20 backdrop-blur-xl hover:border-blue-400/50 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-2 transition-all duration-500">
                                <div class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center text-3xl text-white shadow-xl group-hover:scale-110 transition-transform duration-300">
                                    📅
                                </div>
                                <p class="text-xs text-slate-400 uppercase font-bold tracking-widest mb-2">Fecha de Acceso</p>
                                <p id="fecha" class="text-2xl font-black text-white group-hover:text-blue-400 transition-colors">13 JUL 2025</p>
                            </div>

                            <div class="group text-center p-8 rounded-3xl border border-slate-600/30 bg-gradient-to-br from-violet-900/20 to-purple-900/20 backdrop-blur-xl hover:border-violet-400/50 hover:shadow-2xl hover:shadow-violet-500/20 hover:-translate-y-2 transition-all duration-500">
                                <div class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-violet-500 to-purple-500 rounded-2xl flex items-center justify-center text-3xl text-white shadow-xl group-hover:scale-110 transition-transform duration-300">
                                    🕐
                                </div>
                                <p class="text-xs text-slate-400 uppercase font-bold tracking-widest mb-2">Hora de Entrada</p>
                                <p id="hora_ingreso" class="text-2xl font-black text-white group-hover:text-violet-400 transition-colors">08:30 AM</p>
                            </div>

                            <div class="group text-center p-8 rounded-3xl border border-slate-600/30 bg-gradient-to-br from-emerald-900/20 to-teal-900/20 backdrop-blur-xl hover:border-emerald-400/50 hover:shadow-2xl hover:shadow-emerald-500/20 hover:-translate-y-2 transition-all duration-500">
                                <div class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center text-3xl text-white shadow-xl group-hover:scale-110 transition-transform duration-300">
                                    🕓
                                </div>
                                <p class="text-xs text-slate-400 uppercase font-bold tracking-widest mb-2">Hora de Salida</p>
                                <p id="hora_salida" class="text-2xl font-black text-white group-hover:text-emerald-400 transition-colors">-- : --</p>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <!-- Footer mejorado -->
                <footer class="text-center border-t border-gradient-to-r from-transparent via-slate-600/30 to-transparent pt-8 mt-12">
                    <p class="text-slate-400 text-lg">
                        Sistema de Control de Acceso —
                        <span class="font-black bg-gradient-to-r from-cyan-400 via-blue-400 to-violet-400 bg-clip-text text-transparent">
                    ...
                    <div class="mt-4 flex justify-center gap-2">
                        ...
                        <div class="w-2 h-2 bg-violet-400 rounded-full animate-pulse" style="animation-delay: 1s;"></div>
                    </div>
                </footer>
            </div>
        </div>
            ...
            function actualizarPantalla() {
                fetch('/api/ultimo-acceso')
                    ...
                    .then(data => {
                        ...
                        if (data.card.estado) {
                            statusCard.className = 'relative text-center p-10 rounded-3xl border border-emerald-500/40 bg-gradient-to-br from-emerald-900/20 to-green-900/20 backdrop-blur-xl shadow-2xl group hover:scale-[1.02] transition-all duration-500';
                            statusText.textContent = 'Acceso Autorizado';
                            statusText.className = 'text-4xl font-black text-emerald-400 uppercase tracking-widest drop-shadow-lg mb-3';
                            statusIcon.textContent = '🔓';
                        } else {
                            statusCard.className = 'relative text-center p-10 rounded-3xl border border-red-500/40 bg-gradient-to-br from-red-900/20 to-rose-900/20 backdrop-blur-xl shadow-2xl group hover:scale-[1.02] transition-all duration-500';
                            statusText.textContent = 'Acceso Denegado';
                            statusText.className = 'text-4xl font-black text-red-400 uppercase tracking-widest drop-shadow-lg mb-3';
                            statusIcon.textContent = '🔒';
                        }
                    })
                    .catch(error => {
